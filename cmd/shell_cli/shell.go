...
var modules = map[string]map[string]string{
	"Config": {
		...
		"EnableInfoContainer": strconv.FormatBool(config.EnableInfoContainer),
		"EnableVulContainer":  strconv.FormatBool(config.EnableVulContainer),
	},
	"InformationScan": {
...
func getArgsVariable(param string, value interface{}) (result string) {
	typeHandlers := map[string]func(value interface{}) string{
		...
		"EnableVulContainer": handleVulContainer,
	}
